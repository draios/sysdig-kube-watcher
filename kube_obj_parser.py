...
class KubeObjParser(object):
    def __init__(self, customer_admin_sdclient, sysdig_superuser_token, sdc_url):
    ...
    def parse(self, objdata):
        if 'annotations' in objdata['metadata']:
            if 'sysdigTeamMembers' in objdata['metadata']['annotations']:
                uids = []
                users = []
